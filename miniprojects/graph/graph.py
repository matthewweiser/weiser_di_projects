...
#test scratch:
a='Bill Clinton and Rand Paul, Dr. Murray Pepper, former Mayor of Beverly Hills Vicki Reynolds, Former Governor of CA Mr. Gray Davis, and Sharon Ryer Davis and toothfariy'
re.split('Mrs. |Hon. |Mr. |Dr. |, with | with |, and |, | and ',a)
re.split('; |, |\*|\n',a)
...
#datetime.strptime(df['date'][0])
#datetime.datetime.strptime("30 Nov 00", "%d %b %y")
#time.strptime("30 Nov 00", "%d %b %y")


time.strptime(" Wednesday, December 3, 2015 ", " %A, %B %d, %Y ")[1]


df2 = df[ df['date'].apply(time.strptime)[1] > 6 ]

time.strptime(df['date'][0])
for c in allCapt:
